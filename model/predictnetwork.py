'''
    This is mostly copied from https://github.com/yikangshen/PRPN/blob/master/ReadingNetwork.py
'''
...
from utils.blocks import softmax, ResBlock
...
class PredictNetwork(nn.Module):
    def __init__(self, ninp, nout, nslots, dropout, nlayers=1):
        ...
        self.ffd = nn.Sequential(nn.Dropout(dropout), nn.Linear(ninp * 2, nout),
                                 nn.BatchNorm1d(nout), nn.Tanh())
